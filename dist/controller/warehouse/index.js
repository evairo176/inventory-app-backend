...
const addWarehouseController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const checkSlug = yield lib_1.db.warehouse.findFirst({
            where: {
                slug: slug,
            },
        });
        ...
        const warehouse = yield lib_1.db.warehouse.create({
            data: {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Create warehouse successfully", warehouse);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[CREATE_WAREHOUSE]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const getAllWarehouseController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const warehouse = yield lib_1.db.warehouse.findMany({
            orderBy: {
                updatedAt: "desc",
            },
            where: {
        ...
        if (!warehouse) {
            return (0, utils_1.sendResponse)(res, 400, "Warehouse not found!");
        }
        return (0, utils_1.sendResponse)(res, 200, "Get all warehouse successfully", warehouse);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[GET_ALL_WAREHOUSE]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const createBulkWarehousesController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Create Bulk warehouse successfully", warehouses);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[CREATE_BULK_WAREHOUSE]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const deleteWarehouseByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (!params.id) {
            return (0, utils_1.sendResponse)(res, 400, "Warehouse Id not found");
        }
        const warehouse = yield lib_1.db.warehouse.findFirst({
            where: {
                id: params.id,
            },
        });
        ...
        const deleteWarehouse = yield lib_1.db.warehouse.delete({
            where: {
                id: params.id,
            },
        });
        return (0, utils_1.sendResponse)(res, 200, "Delete warehouse successfully", deleteWarehouse);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[DELETE_WAREHOUSE]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const getWarehouseByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Get warehouse by id successfully", warehouse);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[GET_WAREHOUSE_BY_ID]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const updateWarehouseByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const warehouseUpdate = yield lib_1.db.warehouse.update({
            where: {
                id: params.id,
            },
            data: {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Update warehouse by id successfully", warehouseUpdate);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[UPDATE_WAREHOUSE_BY_ID]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
