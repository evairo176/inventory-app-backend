...
const addPermissionController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const checkPermissionName = yield db_1.db.permission.findFirst({
            where: {
                permissionName: body === null || body === void 0 ? void 0 : body.permissionName,
            },
        });
        if (checkPermissionName) {
            return (0, send_response_1.sendResponse)(res, 400, "Permission Name is already exist");
        }
        const permission = yield db_1.db.permission.create({
            data: {
        ...
        return (0, send_response_1.sendResponse)(res, 200, "Create permission successfully", permission);
    }
    catch (error) {
        return (0, send_response_1.sendResponse)(res, 500, "[CREATE_PERMISSION]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const getAllPermissionController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let permission = yield db_1.db.permission.findMany({
            orderBy: {
                updatedAt: "desc",
            },
        });
        ...
        if (query === null || query === void 0 ? void 0 : query.role) {
            permission = yield db_1.db.permission.findMany({
                orderBy: {
                    displayName: "asc",
                },
            });
        }
        return (0, send_response_1.sendResponse)(res, 200, "Get all permission successfully", permission);
    }
    catch (error) {
        return (0, send_response_1.sendResponse)(res, 500, "[GET_ALL_PERMISSION]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const deletePermissionByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (!params.id) {
            return (0, send_response_1.sendResponse)(res, 400, "Permission Id not found");
        }
        const permission = yield db_1.db.permission.findFirst({
            where: {
                id: params.id,
            },
        });
        if (!permission) {
            return (0, send_response_1.sendResponse)(res, 400, "Permission not found");
        }
        const deletePermission = yield db_1.db.permission.delete({
            where: {
                id: params.id,
            },
        });
        return (0, send_response_1.sendResponse)(res, 200, "Delete permission successfully", deletePermission);
    }
    catch (error) {
        return (0, send_response_1.sendResponse)(res, 500, "[DELETE_PERMISSION]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const getPermissionByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return (0, send_response_1.sendResponse)(res, 200, "Get permission by id successfully", permission);
    }
    catch (error) {
        return (0, send_response_1.sendResponse)(res, 500, "[GET_PERMISSION_BY_ID]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const updatePermissionByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const permissionUpdate = yield db_1.db.permission.update({
            where: {
                id: params.id,
            },
            data: {
        ...
        return (0, send_response_1.sendResponse)(res, 200, "Update permission by id successfully", permissionUpdate);
    }
    catch (error) {
        return (0, send_response_1.sendResponse)(res, 500, "[UPDATE_PERMISSION_BY_ID]: Internal Error", error);
    }
});
