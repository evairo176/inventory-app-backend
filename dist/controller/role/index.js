...
const addRoleController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const checkAbbreviation = yield lib_1.db.role.findFirst({
            where: {
                roleName: body === null || body === void 0 ? void 0 : body.roleName,
            },
        });
        if (checkAbbreviation) {
            return (0, utils_1.sendResponse)(res, 400, "Role Name is already exist");
        }
        const role = yield lib_1.db.role.create({
            data: {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Create role successfully", role);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[CREATE_ROLE]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
exports.addRoleController = addRoleController;
const getAllRoleController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const role = yield lib_1.db.role.findMany({
            include: {
                permissions: {
                    include: {
                        permission: true,
        ...
        return (0, utils_1.sendResponse)(res, 200, "Get all role successfully", role);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[GET_ALL_ROLE]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const deleteRoleByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (!params.id) {
            return (0, utils_1.sendResponse)(res, 400, "Role Id not found");
        }
        const role = yield lib_1.db.role.findFirst({
            where: {
                id: params.id,
            },
        });
        if (!role) {
            return (0, utils_1.sendResponse)(res, 400, "Role not found");
        }
        const deleteRole = yield lib_1.db.role.delete({
            where: {
                id: params.id,
            },
        });
        return (0, utils_1.sendResponse)(res, 200, "Delete role successfully", deleteRole);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[DELETE_ROLE]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const getRoleByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Get role by id successfully", role);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[GET_ROLE_BY_ID]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const updateRoleByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existingRole = yield lib_1.db.role.findFirst({
            where: {
                id: params.id,
            },
        ...
        if (existingRole.roleName !== (body === null || body === void 0 ? void 0 : body.roleName)) {
            const checkRoleName = yield lib_1.db.role.findFirst({
                where: {
                    roleName: body === null || body === void 0 ? void 0 : body.roleName,
                },
            });
        ...
        const removeRole = yield lib_1.db.rolePermission.deleteMany({
            where: {
                roleId: params === null || params === void 0 ? void 0 : params.id,
            },
        });
        // Create new RolePermission records
        yield Promise.all(body === null || body === void 0 ? void 0 : body.permissionIds.map((permissionId) => lib_1.db.rolePermission.create({
            data: {
                roleId: params === null || params === void 0 ? void 0 : params.id,
                permissionId,
            },
        ...
        const updatedRole = yield lib_1.db.role.update({
        ...
        return (0, utils_1.sendResponse)(res, 200, "Update role by id successfully", removeRole);
    }
    catch (error) {
        ...
        return (0, utils_1.sendResponse)(res, 500, "[UPDATE_ROLE_BY_ID]: Internal Error", error.message);
    }
});
