...
const addSupplierController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const checkSupplierExist = yield lib_1.db.supplier.findFirst({
            where: {
        ...
        const supplier = yield lib_1.db.supplier.create({
            data: {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Create supplier successfully", supplier);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[CREATE_SUPPLIER]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const getAllSupplierController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const supplier = yield lib_1.db.supplier.findMany({
            orderBy: {
                updatedAt: "desc",
            },
            // where: {
        ...
        if (!supplier) {
            return (0, utils_1.sendResponse)(res, 400, "Supplier not found!");
        }
        return (0, utils_1.sendResponse)(res, 200, "Get all supplier successfully", supplier);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[GET_ALL_SUPPLIER]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const createBulkSuppliersController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Create Bulk supplier successfully", suppliers);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[CREATE_BULK_SUPPLIER]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const deleteSupplierByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (!params.id) {
            return (0, utils_1.sendResponse)(res, 400, "Supplier Id not found");
        }
        const supplier = yield lib_1.db.supplier.findFirst({
            where: {
                id: params.id,
            },
        });
        ...
        const deleteSupplier = yield lib_1.db.supplier.delete({
            where: {
                id: params.id,
            },
        });
        return (0, utils_1.sendResponse)(res, 200, "Delete supplier successfully", deleteSupplier);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[DELETE_SUPPLIER]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const getSupplierByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Get supplier by id successfully", supplier);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[GET_SUPPLIER_BY_ID]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
...
const updateSupplierByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const supplierUpdate = yield lib_1.db.supplier.update({
            where: {
                id: params.id,
            },
            data: {
        ...
        return (0, utils_1.sendResponse)(res, 200, "Update supplier by id successfully", supplierUpdate);
    }
    catch (error) {
        return (0, utils_1.sendResponse)(res, 500, "[UPDATE_SUPPLIER_BY_ID]: Internal Error", error === null || error === void 0 ? void 0 : error.message);
    }
});
